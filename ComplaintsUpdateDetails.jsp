<%-- 
    Document   : ComplaintsUpdateDetails
    Created on : Jul 14, 2021, 10:08:20 AM
    Author     : Cool Tech
--%>
...
<body>
        <%
            ...
            String myQuery = "select * from complaints "
                      + "where complaintsID=" + complaintsID;          
            ...
            while(myRs.next()){
                ...
                subject = myRs.getString(4);
                message = myRs.getString(5);
            }
            myConnection.close();
        %>
<!--<div class="jumbotron">
...
<!--<div class="body">
    <center>
        <form action="ComplaintsUpdateDetails2.jsp" method="POST">
            <h3>Complaint Details</h3><br>
                    <input type="hidden" name="hidid" value="<%=complaintsID%>"/>
			...
			<tr>
                            ...
                            <td>
                                <input type="text" name="empID" value="<%=complaintsID%>" style="width:150%; height:40px;" readonly>
                            </td>
                        </tr>
                        <tr>
                            <td><br></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="phoneNo" value="<%=subject%>" style="width:150%;height:40px;">
                            </td>
                        </tr>
                        <tr>
                            <td><br></td>
                        ...
                        <tr>
                                ...
                                <td><!--<input type="submit" value="Update"/>
                                    <input type="button" value="Back"
                                           onclick="window.location.href = 'complaintsManagement.jsp'; return false"/>
                                </td>
                        </tr>
                    </table>
                </form>
            ...
            <div class="container">
                <h2>View Customer's complaints</h2>
                <p>You can view customer's complaints to upgrade your customer's satisfaction. </p>
                <form action="ComplaintsUpdateDetails2.jsp" method="POST">
                  <input type="hidden" name="hidid" value="<%=complaintsID%>"/>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" id="inputdefault" type="text" name="phoneNo" value="<%=subject%>" readonly>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" id="inputdefault" type="button" value="Back" 
                           onclick="window.location.href = 'ComplaintsList.jsp'; return false"/>
                  </div>
                </form>
            </div>                                    
