<%-- 
    Document   : Invoice2
    Created on : Jul 14, 2021, 5:21:22 PM
    Author     : Cool Tech
--%>
...
<html>
	...
	<body>
            <%
                ...
                String delivery = request.getParameter("del");
				...
				<tr class="top">
					<td colspan="2">
						<table>
							<tr>
								<td class="title">
									<img src="dashboard photo/logo.jpg" style="width: 50%; max-width: 100px; height: 100px" />
								</td>
				...
				<tr class="information">
					<td colspan="2">
						<table>
							<tr>
								<td>
									Nasi Arab AL-Lazeez<br />
									Jalan Persinggahan pantai Batu Buruk<br>
