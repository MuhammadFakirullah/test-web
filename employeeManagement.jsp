<%-- 
    ...
    Created on : Jul 12, 2021, 2:13:44 PM
    Author     : Cool Tech
--%>
...
<div class="body">
    <center>
        <table>
            <tr>
                <td><img src="dashboard photo/register.png" style="width: 100px; height: 100px;" alt="Image"></td>
                <td>&nbsp;&nbsp;<a href="employeeRegistration.jsp">Register New Employee</a></td>
            </tr>
            <tr>
                <td><br></td>
            </tr>
            <tr>
                <td><img src="dashboard photo/employeelist.png" style="width: 100px; height: 100px;" alt="Image"></td>
                <td>&nbsp;&nbsp;<a href="employeeListDetails.jsp">List of employee</a></td>
            </tr>
            <tr>
                <td><br></td>
            </tr>
            <tr>
                <td><img src="dashboard photo/searchEmployee.png" style="width: 100px; height: 100px;" alt="Image"></td>
                <td>&nbsp;&nbsp;<a href="searchEmployee.jsp">Search Employee</a></td>
            </tr>
        </table>
    </center>
</div>
