<%-- 
    Document   : searchOrderResult
    Created on : Jul 12, 2021, 4:56:35 PM
    Author     : Cool Tech
--%>
...
<div class="body">
    <%
            try{
                ...
                String myQuery = "select * from orderq where ordDate='"+date+"'";
                ...
                while(rs.next()){
                    ...
                    out.println("<td><a href=OrderUpdateDetails.jsp?orderID="
                            +rs.getString(1) + "><i class='far fa-edit' style='font-size:24px'></i></a>"
                            + "&nbsp;"+"<a href=OrderDeleteDetails.jsp?orderID="
